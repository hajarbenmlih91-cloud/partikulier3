<?php
/**
 * Module lexique de la rédaction multilingue (lot C1, découpe de
 * class-listing-i18n.php — 955 lignes historiques).
 *
 * Langues prises en charge et lexique par langue (fr/en/ar) : le vocabulaire
 * de composition des annonces (propriétaire, action, pièces, terrasse,
 * exposition, formules particulier-à-particulier). Le contenu des entrées
 * est déplacé VERBATIM — l'empreinte du corpus gelé (bcab5c37, lot B6/C)
 * doit rester identique après le lot.
 *
 * Lot C1 (extraction) : ce lexique est le port de repli autonome du thème
 * (REG-5). Le service actif vit côté plugin partikulier-core 2.7+
 * (\Partikulier\Core\Domain\I18n\I18nContentService) — la couture du shell
 * class-listing-i18n.php délègue quand la classe existe.
 *
 * @package Partikulier
 */
...
trait Partikulier_Listing_I18n_Lexicon {
         ...
         * @return string[]
         */
        public static function languages_local() {
