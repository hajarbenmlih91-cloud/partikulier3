<?php
/**
 * Catalogue de repli du chrome public (lot B6, découpe REG-3 de
 * class-localization.php — 990 lignes historiques).
 *
 * Repli déterministe des chaînes du shell public lorsque Polylang n'a pas
 * encore reçu leurs traductions dans l'administration (en-tête, navigation,
 * pied de page, boutons d'action). Le contenu des entrées est déplacé
 * VERBATIM — l'empreinte du corpus gelé avant découpe (REG-3, lot B6) doit
 * rester identique après le lot.
 *
 * Lot C2 (extinction) : la propriété du catalogue passe au plugin
 * partikulier-core 2.8+ (\Partikulier\Core\Domain\I18n\ChromeDictionary,
 * port VERBATIM prouvé par contrat C2A-002) — ces données côté thème sont
...
trait Partikulier_Localization_Chrome {
