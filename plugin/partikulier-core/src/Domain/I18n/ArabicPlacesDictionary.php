<?php
/**
 * Dictionnaire des lieux en arabe (SE-036, E-3601 — données pures).
 *
 * Carte intégrée du référentiel marocain : villes et quartiers, clés
 * normalisées (minuscules, sans accents) → formes arabes. Étendue au lot
 * SE-036 pour couvrir les 30 villes et les 180 clés de quartiers du
 * référentiel (rédaction de la reprise v2). Les overrides importés par
 * l'administration (option pk_places_ar, écran « Villes & quartiers »)
 * priment sur cette carte — la résolution vit dans ListingVocabulary.
 *
 * Classe de DONNÉES pure (pattern ChromeDictionary/FormsDictionary) :
 * aucune table, aucun hook, aucune écriture. Découpe CA-4 : le module
 * ListingVocabulary reste ≤300 lignes (C1A-009).
 */
...
final class ArabicPlacesDictionary
{
	/**
